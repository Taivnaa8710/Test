...
tmp_fake_path = 'Dataset/tmp_fake_faces/'
...
for filename in metadata.keys():
    ...
    tmp_path = os.path.join(os.path.join(base_path, get_filename_only(filename)), 'faces380x380')
    print(tmp_path)
...
splitfolders.ratio(dataset_path, output='Dataset/split_dataset/', seed=1377, ratio=(.8, .1, .1)) # default values
